...
-----------------------------
 ...
 h  page left      - Moves one screen width toward the left of the      
                     ...
                     already displayed                                  
 l  page righ  t   - Moves one screen width toward the right of the     
...
----------------------------------
  ...
  eturn   forward  - Push the current page on the history stack, and    
...
Alexandre Miquel, Jun Furuse Didier Remy, Pierre Weis, Xavier Leroy, Roberto
