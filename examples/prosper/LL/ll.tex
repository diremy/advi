...
\hfill{\adviembed[sticky=advianim]{0.8cm}{0.9cm}{animate -geometry !g! -window !p advilogo.anim.gif}}
} \vss}}
...
\pause
  \begin{center}
        \begin{tabular}{|c|r|r|r|r|c|c|}
         \hline & Income & Profit & \% & Employees & \adviannot{$C$}(-2,1){Citoyennet\'e${}^-1$}& \adviannot{$C^{-1}$}(-1,1){Citoyennet\'e}\\\hline
  ...
  \begin{description}
    ...
    \item[Nature des logiciels]: \mbox{}\\une tr\`es grande quantit\'e de logiciel
         ...
         \adviannot{facilement}(-2,2){\begin{minipage}{20em}
                                       ...
                                       les prive des contributions precieuses de la communeaut\'e
                                       \end{minipage}}
...
\slidetitle{Des questions?}
  \begin{description}
    \item[est-ce du PowerPoint] ? \\\pause \adviannot{Non}(1,1){c'est Active DVI!}\pause
    \item[qu'est-ce que Active DVI] ? \pause un visualiseur DVI \'ecrit enti\`erement en Ocaml \`a l'INRIA\ldots{}
    \item[\ldots{}] \ldots{}
  \end{description}
\end{slide}}
\end{document}
