...
{\bf Benchmarks}: consistantly faster than any other functionnal programming
...
-- No counterparts in typing.\\
-- Raised with {\tt raise}, handled via pattern matching.
\begin{small}\begin{alltt}
try
...
\pause\textcolor{green}{\advitransbox{slide,from=left}{functionnal, and}}
\pause\textcolor{red}{\advitransbox{slide,from=top}{object}}
\pause\textcolor{black}{\advitransbox{slide,from=bottom}{paradigms.}}
%imperative, functionnal, and objects paradigms.
\end{center}

\pause
On top: {\advitransbox{block,steps=50}{a first order functionnal language}}\\
