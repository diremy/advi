...
Environment \verb"allt" is nice to write type-writer text (presumably program
samples). In environment \verb"allt" you can still use your favorite
{\LaTeX} macros, hence coloring text and changing styles.
