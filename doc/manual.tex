...
under LGPL license and is available at \url{http://pauillac.inria.fr/~miquel/}. 
...
Conversely, you may run \doctt{advi} with the \doctt{-exec} option to
automatically launch embedded applications.

The last safety option is the default one: the \doctt{-ask} option
...
presentation.) 
The safe \doctt{-ask} option is set by default. It can also be set for
