...
{\ActiveDVI} is copyright from INRIA\footnote {\copyright\space 2002, INRIA}
and distributed under the LGPL license ---see the LGPL file included in the
distribution.
\end{abstract}
...
Roberto~Di~Cosmo, Xavier~Leroy, and Alan~Schmidt. 
...
will inhibates the execution of embeded applications. 
This applies in particular if you choose {\ActiveDVI} as your default 
{\tt metamail} previewer for the {\tt application/x-dvi} mime-type . 
...
with a bias towards programming: special effects can easily 
...
using or defining simple {\LaTeX} macros, writting new {\LaTeX} package
