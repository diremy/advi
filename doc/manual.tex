...
{\ActiveDVI} is copyright \copyright 2001--{\adviyear} INRIA
and distributed under the Gnu Library General Public License ---see the LGPL
file included in the distribution.

\ifhevea
This manual is  available as
\ahref {http://advi.inria.fr/manual.html}{sevral HTML files},
\ahref {http://advi.inria.fr/manual.html}{one single HTML file},
or in \ahref {http://advi.inria.fr/manual.pdf}{PDF format}.
\fi
\end{abstract}
