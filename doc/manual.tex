...
will allow the command an activation of the link \docid{tag}
not only move to the page where \docid{text} occurs, but also emphasize
\docid{text}. 

(If you are viewing this document with \hypertarget{a}{\ActiveDVI}, you may
move click \hyperlink{a}{here} to see.) 
...
single page. This can be changed with the option \doctt{-thumbnail\_scale}. 
