...
\title {{\ActiveDVI} \\ reference manual}
...
- List all implementors?

- Special thank to Alexandre Miquel.
...
However, this currently uses {\tt XCutbuffer} than the {\\t XSelection}
mechanism. 
\begin {itemize}
\item
...
\end {itemize}
Moreove, Shift left-click dump an ascii representation of click 
...
\docid{prefix}\docid{suffix} are the word constituant surrounding the
