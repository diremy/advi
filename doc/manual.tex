...
\bigskip
{\ActiveDVI} is copyright \copyright\space 2001, 2003 INRIA
...
More involved examples (including Makefiles to compile the whole thing)
can be found in the directory {\tt examples} of the distribution. (In
particular, this example is given in {\tt examples/slitex/simplistic}.)
