...
The recorded code must all fit on the same DVI page, which is 
left under the user's responsability.
...
The DVI must have been recorded on the same DVI page and before the play
action is performed.
...
extension to the \doctt{color} package, that defines a large set of X
colors names, as found in the file {\tt rgb.txt} of a typical X
installation (this file is generally located on {\tt
