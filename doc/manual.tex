...
\ahref {manualxxx.html}{several HTML files}
or in \ahref {manual.pdf}{PDF format}.
\fi
\end{abstract}
...
{\ActiveDVI} is based on Mldvi, written and 
\ahref{http://www.pps.jussieu.fr/~miquel/soft.html}{distributed}
by \ahref{http://www.pps.jussieu.fr/~miquel/}{Alexandre~Miquel}
under the LGPL license\footnote {At the url
\url{http://www.pps.jussieu.fr/~miquel/soft.html}.}.
This constitutes the core rendering engine.  
{\ActiveDVI} has then been developed by 
%
\ahref{http://jun.furuse.info/}{Jun Furuse},
\ahref{http://gallium.inria.fr/\home{remy}/}{Didier R{\'e}my}, and
\ahref{http://gallium.inria.fr/\home{weis}/}{Pierre Weis},
with contributions by 
\ahref{http://wwwdgeinew.insa-toulouse.fr/\home{lebotlan}/}{Didier Le Botlan},
\ahref{http://www.dicosmo.org/}{Roberto Di Cosmo},
\ahref{http://gallium.inria.fr/\home{xleroy}/}{Xavier Leroy},
\ahref{http://www.pps.jussieu.fr/\home{miquel}/}{Alexandre Miquel}, and
\ahref{http://sardes.inrialpes.fr/\home{aschmitt}/}{Alan Schmitt}.
...
You may also retreive the github sources from \url
{https://github.com/diremy/advi} either by cloning sources or by retreiving
a tar ball.  In both cases, you must ensure that the following \verb"opam"
packages
\begin{verbatim}
        "dune" {>= "2.5"}
        "graphics" {>= "5.1.1"}
...
\end{verbatim}
will tell you what to do. In particular, you may install \latex source file
...
\end{verbatim}
will them the files that will be installed.
...
The documentation, available at \url {http://advi.inria.fr/manual.html}, is
