...
As mentioned, the safe \doctt{-ask} option is the default, if nothing
...
scale by the machine administrator (in file \doctt{/etc/advirc}), or
...
-fgcolor grey95
\end{verbatim}
is a valid initialisation file that sets the policy to \doctt{-exec},
...
Active anchors are annotated pieces of text that gets associated
