...
\flushright{\includegraphics[width=0.25\textwidth]{../tex/advilogo.eps}}
...
\settransition{block from=center steps=50000}
...
\wait{0.1}{\Huge \bf Allo }
\wait{0.1}{\Huge \bf Hola }
\wait{0.1}{\Huge \bf Salut }
\wait{0.1}{\Huge \bf Au revoir}
