...
\advitransition{slide, from=left, steps=30}
...
\advitransition{block,from=topleft,steps=20000}
...
\item \verb+\advitransition{block,from=topleft,steps=10000}+
\end{itemize}
...
\advitransition{block,from=center,steps=50000}
