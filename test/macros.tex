...
\verb!  !{\color{blue}\verb!\hide{tag2}{\includegraphics[width=0.1\textwidth]{../tex/caml.eps}!}\verb!}&!
\verb!  !{\color{blue}\verb!\hide{tag3}{\includegraphics[width=0.1\textwidth]{../tex/caml.eps}!}\verb!}!
\verb!\end{tabular}!
...
\begin{tabular}[t]{cccc}
  ...
  \hide{tag2}{\includegraphics[width=0.1\textwidth]{../tex/caml.eps}}&
  \hide{tag3}{\includegraphics[width=0.1\textwidth]{../tex/caml.eps}}
\end{tabular}
\pause
\play{tag2}
\pause
