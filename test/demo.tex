...
%\adviembed[sticky=advixanim]{1cm}{1cm}{xanim +F +Sx40 +Sy40 +Sr -Zr +q -Wr +W!g +W!p advi.anim.gif}
...
\begin{itemize}
  \item Any CamlTk application using\\
   ...
   \verb|\adviembed{5cm}{1cm}{wish ./watch -geometry !g -use !p}|\\
   \adviembed[persistent=button]{5cm}{0.71cm}{wish ./watch -geometry !g -use !p}
\pause
  \item Possibly interactive ! (using CamlTk)\\
   \verb|\adviembed{6.5cm}{9.5cm}{./taquin -geometry !g -use !p dojoji.gif}|\\
