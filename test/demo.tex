...
(by Jun~Furuse, Didier~R{\'{e}}my, Pierre Weis, and Roberto Di Cosmo).
...
leaves the anchor region. For instance, scratch those stamps with the
mouse to see how much you win \verb":)"
...
\advirecord{2}{\textcolor{c3}{you can use graphics}}\\
\advirecord{3}{{\includegraphics[width=0.02\textwidth]{../tex/caml.eps}}}\\
\advirecord{31}{{\includegraphics[width=0.03\textwidth]{../tex/caml.eps}}}\\
\advirecord{32}{{\includegraphics[width=0.04\textwidth]{../tex/caml.eps}}}\\
\advirecord{33}{{\includegraphics[width=0.08\textwidth]{../tex/caml.eps}}}\\
\advirecord{34}{{\includegraphics[width=0.1\textwidth]{../tex/caml.eps}}}\\
\advirecord{35}{{\includegraphics[width=0.02\textwidth]{../tex/caml.eps}\
...
\includegraphics[width=0.1\textwidth]{../tex/caml.eps}}}\\
\advirecord{36}{{\includegraphics[width=0.1\textwidth]{world}}}\\
