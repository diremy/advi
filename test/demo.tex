...
\hfill{\adviembed[name=advianim,mode=sticky]{1.56cm}{1.824cm}{animate -geometry !g! -window !p advilogo.anim.gif}}
} \vss}}
...
\begin{itemize}
  \item Any CamlTk application using\\
   ...
   \verb|\adviembed[mode=persistent]{5cm}{1cm}{wish ./watch -geometry !g -use !p}|\\
   \adviembed[mode=persistent]{5cm}{0.71cm}{wish ./watch -geometry !g -use !p}
\pause
  \item Possibly interactive ! (using CamlTk)\\
   \verb|\adviembed[mode=persistent]{6.5cm}{9.5cm}{./taquin -geometry !g -use !p dojoji.gif}|\\
  \adviembed[mode=persistent]{7.5cm}{11cm}{./taquin -geometry !g -use !p dojoji.gif}
