...
%\def\stickyembed#1#2#3#4{\mbox{\special {advi: embed name="#1" type=sticky width=#2 height=#3 command="#4"}{\vbox to #3{\hbox to #2{}}}}}

%\def\persistentembed#1#2#3#4{\mbox{\special {advi: embed name="#1" type=persistent width=#2 height=#3 command="#4"}{\vbox to #3{\hbox to #2{}}}}}
...
\item Similarly, \verb|animate| can display animations\\
    ...
    \stickyembed{xanim}{2cm}{2cm}{animate -geometry !g -window !p mmm.anim.gif}
...
\begin{itemize}
  \item Any CamlTk application using\\
   ...
   \persistentembed{button}{2.3cm}{0.71cm}{./but -geometry !g -use !p}

  \item Possibly interactive !\\
   \verb|\embed{6.5cm}{9.5cm}{./taquin -geometry !g -use !p dojoji.gif}|\\
  \persistentembed{taquin}{7.5cm}{11cm}{./taquin -geometry !g -use !p dojoji.gif}
...
\begin{itemize}
 ...
 \item An Xterm running an interesting application:\\
   \verb|\embed{5cm}{5cm}{xterm -geometry 50x10+!x+!y -e ocaml}|\\
   \embed{5cm}{5cm}{xterm -geometry 50x10+!x+!y -e ocaml}
\end{itemize}
