...
\item[+] psfile special with cache (by Jun Furuse)
    ...
    \item \verb+\record+ \& \verb+\play+ feature to change the colour
     ...
     \begin{itemize}
       \item mark the text with a tag name:\\
         $\tt{\backslash}record\{this\}\{\recplay{this}{Warning~to~the~casual~user}\}$
       \item then change the current text color and replay the tagged text:
      $\tt{\backslash}play\{this\}$.
     \end{itemize}
      For instance, display {\tt this} in red:\\
      \pause
      \verb+\textcolor{red}{\play{this}}+
      \textcolor{c1}{\play{this}}\pause\\
      or in green
      \verb+\textcolor{green}{\play{this}}+
      \textcolor{green}{\play{this}}\pause\\
      Using pauses and color settings you can get
      \recplay{this}{various}
      \textcolor{red}{\play{this}}\pause%
      \recplay{this}{color}
      \textcolor{c2}{\play{this}}\pause%
      \recplay{this}{effects}
      \textcolor{c3}{\play{this}}\pause%
      \recplay{this}{in}
      \textcolor{c4}{\play{this}}\pause%
      \recplay{this}{your}
      \textcolor{c5}{\play{this}}\pause%
      \recplay{this}{texts}
      \textcolor{c6}{\play{this}}\pause%
      \recplay{this}{!}\\
      \textcolor{red}{\play{this}}\pause%
...
rectangle where the application will draw material.

\begin{itemize}
\item The \verb"display" command (from ImageMagick) can show any image into your
presentation using:\\
\verb|\embed{3cm}{3.3cm}|\verb|{display -geometry !g -window !p advilogo.gif}|\\
...
\item Similarly, \verb|animate| can display animations\\
    ...
    \verb|\embed{2cm}{2cm}{animate -geometry !g -window !p mmm.anim.gif}|\\
...
\begin{center}
{\large\bf I have four words for you!}\\
...
\begin{itemize}
  \item Any CamlTk application using\\
   ...
   \\
   \embed{2.3cm}{0.71cm}{./but -geometry !g -use !p}

  \item Possibly interactive !\\
   \verb|\embed{6.5cm}{9.5cm}{./taquin -geometry !g -use !p dojoji.gif}|\\
   \\
  \embed{6.5cm}{9.5cm}{./taquin -geometry !g -use !p dojoji.gif}
...
Arbitrary other X applications with a somewhat strange
placement, if they do not obey the X geometry specifications.

\begin{itemize}
 \item Xeyes using the macro command \verb|embed|:\\
   \verb|\embed{2cm}{2cm}{xeyes -bw 0 -shape -geometry 55x40+400+420}}|\\
   \embed{2cm}{2cm}{xeyes -bw 0 -shape -geometry 55x40+400+420}

 \item An Xterm running an interesting application:\\
   \verb|\embed{5cm}{5cm}{xterm -geometry 50x10+500+420 -e ocaml}|\\
   \embed{5cm}{5cm}{xterm -geometry 50x10+500+420 -e ocaml}
\end{itemize}
...
itself. Thus, some PS tricks still not work.
\begin {itemize}
...
\item[-]
However, text arrow labels do not work, so far.

\item[-]
PS tricks overlays do not work either
...
\smallskip
{\verb"\usepackage [annot,batch]{advi}"}
\smallskip
