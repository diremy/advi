...
\begin{quote}
  \begin{verbatim}
      \advibg{color = green, fun = "d1gradient"} 
   \end{verbatim}
\end{quote}
\advibg{color = green, fun = "d1gradient"} 
...
\begin{quote}
  \begin{verbatim}
      \advibg{color = green, fun = "d2gradient"} 
   \end{verbatim}
\end{quote}
\advibg{color = green, fun = "d2gradient"} 
...
\begin{quote}
  \begin{verbatim}
      \advibg{color = green, fun = "cgradient"} 
   \end{verbatim}
\end{quote}
\advibg{color = green, fun = "cgradient"} 
...
\begin{quote}
  \begin{verbatim}
      \advibg{color = green, fun = "circgradient"} 
   \end{verbatim}
\end{quote}
\advibg{color = green, fun = "circgradient"} 
...
\begin{quote}
  \begin{verbatim}
  \advibg{color = green, fun = "circgradient", colorstart = "red"} 
   \end{verbatim}
\end{quote}
\advibg{color = green, fun = "circgradient", colorstart = red}
...
\begin{quote}
  \begin{verbatim}
  \advibg{color = cyan, fun = "cgradient", colorstart = "blue"} 
   \end{verbatim}
\end{quote}
\advibg{color = green, fun = "cgradient", colorstart = blue}
...
\advibg{color = lightblue, alpha = 0.1,
        blend = difference, image = "dojoji.gif"} 
\vfill
...
\vfill
{\large {Plain cyan color:\\
 \verb|\advibg{color = cyan}|}}
\vfill
...
\advibg{alpha = "0.1", image = "dojojismall.jpg",
        color = cyan, fun = "vgradient"}

\vfill
{\large {Cyan with vertical gradient\\
 and alpha = 0.1 blended image\\
 \verb|\advibg{alpha = "0.1", image = "dojojismall.jpg",|\\
 \verb|        color = cyan, fun = "vgradient"}|
}}
\vfill

\newpage

\advibg{alpha = "0.2", color = cyan,
        image = "dojojismall.jpg", fun = "vgradient"}

\vfill
{\large {Cyan with vertical gradient and alpha = 0.2 blended image\\
\verb|\advibg{alpha = "0.2", color = cyan,|\\
\verb| image = "dojojismall.jpg", fun = "vgradient"}|
}}
\vfill

\newpage

\advibg{alpha = "0.4", fun = "vgradient", color = cyan, image =
"dojojismall.jpg"}

\vfill
{\large {Cyan with vertical gradient\\
and alpha = 0.4 blended image\\
\verb|\advibg{alpha = "0.4", fun = "vgradient",|\\
\verb|        color = cyan, image = "dojojismall.jpg"}|
}}
\vfill

\newpage

\advibg{alpha = "0.8", fun = "vgradient", color = cyan, image =
"dojojismall.jpg"}

\vfill
{\large {Cyan with vertical gradient\\
 and alpha = 0.8 blended image\\
\verb|\advibg{alpha = "0.8", fun = "vgradient",|\\
\verb|        color = cyan, image = "dojojismall.jpg"}|
}}
\vfill
...
\verb|\advibg{color = cyan, image = "dojojismall.jpg",|\\
\verb|        alpha = 0.25}|
...
\advibg{color = [named]{LemonChiffon}, fun = circgradient,
 colorstart = red, image = "dojojismall.jpg", alpha = 0.25}

\verb|\advibg{color = [named]{LemonChiffon}, fun = circgradient,|\\
\verb|        colorstart = red,|\\
\verb|        image = "dojojismall.jpg", alpha = 0.25}|

\newpage

\vfill
{\large {LemmonChiffon with vertical gradient\\
 and alpha = 0.25 blended
image}}
\vfill
   ...
   \advibg{color = [named]{LemonChiffon},
           ...
           xstart = 0, ystart = 0,
           width = 0.15, height = 1.,
           image = "dojojismall.jpg", alpha = 0.25}
