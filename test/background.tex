...
directives explicitly declared in a page, you have two options:
  ...
  \begin{itemize}
    ...
    \item you can locally issue a \verb|\resetbg| command, that resets
...
\subsection* {TODO:}
  ...
  \begin{itemize}
    \item implement command options to \verb|\setbgimg| to allow
various scaling preferences,
    \item anybody willing to add support for color gradients?
    \item implement command options to \verb|\setbgimg| to support
