...
Notice that, if start or stop is omitted, it is replaced by the actual coordinates
of the box in the dvi screen, so that the effect for the \textcolor{yellow}{Yellow} line
lebow can be obtained by simply writing:\\
